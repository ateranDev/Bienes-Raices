...
?>
      ...
      <div class="contenedor-anuncios">
        <div class="anuncio">
          <picture>
            ...
            <img src="build/img/anuncio1.jpg" loading="lazy" alt="Anuncio" />
          </picture>

          <div class="contenido-anuncio">
            <h3>Casa de lujo en el lago</h3>
            <p>
              Casa del Lago con excelente vista, acabado de lujo a un excelente
              precio
            </p>
            ...
            <a class="boton boton-amarillo-block" href="anuncios.php">
              Ver propiedad
            </a>
          </div>
          <!--.contenido anuncio-->
        ...
        <div class="anuncio">
          <picture>
            ...
            <img src="build/img/anuncio2.jpg" loading="lazy" alt="Anuncio" />
          </picture>
        ...
        <div class="anuncio">
          <picture>
            ...
            <img src="build/img/anuncio3.jpg" loading="lazy" alt="Anuncio" />
          </picture>
    ...
    <section class="imagen-contacto">
      ...
      <p>
        Llene el formulario de contacto y un asesor se pondrá en contacto
      ...
      <section class="testimoniales">
        ...
        <div class="testimoniales">
          <blockquote>
            ...
            a la casa que me ofreciern cumple con todas mis expectativas.
          </blockquote>
          <p>- Adrian Teran</p>
        </div>
      </section>
